...
// const imageBasePath = "../../assets/dashboard/title"
...
//         action: '+ New post',
//         rows: [
//             { id: 9256821912, title: {img: imageBasePath + "/1.png", title: 'Crawford Room, Mortlock Wing....'}, releaseDate: '15:46.673 02/08/2022', view: 200, status: 'Online' },
//             { id: 9256821911, title: {img: imageBasePath + '/1.png', title: 'Crawford Room, Mortlock Wing....'}, releaseDate: '15:46.673 02/08/2022', view: 200, status: 'Online' },
//         ],
//         actionForm: {
//             title: 'Add new post',
...
//         rows: [
//             { id: 9256821912, address: {img: imageBasePath + "/2.png", address: '66b Regent St, Redfern NSW 2016'}, location: 'Hamilton', addedDate: '15:46.673 02/08/2022', status: 'Active' },
//         ],
//         actionForm: {
...
//         action: '+ New voucher',
//         rows: [
//             { id: 9256821912, voucherInfo: {img: imageBasePath + "/3.svg", voucherInfo: 'VOUCHER 50%'}, expiredDate: '15:46.673 02/08/2022', activedDate: '15:46.673 02/08/2022', status: 'Active' },
//         ],
//         actionForm: {
...
//         rows: [
//             { id: 9256821912, event: {img: imageBasePath + "/4.svg", event: 'By food for kids'}, moneyUsed: '300', usedDate: '15:46.673 02/08/2022', status: 'Paid'},
//         ],
//         actionForm: {
...
//             let deepClone: Rows
//             deepClone = JSON.parse(JSON.stringify(mockData[subpageIndex][0]))
